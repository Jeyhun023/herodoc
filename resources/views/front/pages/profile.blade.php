            ...
            <div class="col-lg-4 left">
                <div class="profile_info">
                    <div class="seller-card">
                            ...
                            <div>
                                <div class="user-profile-image">
                                    <label class="user-pict">
                                        <img src="/front/images/user/s10.png" class="img-fluid user-pict-img"
                                            alt="Askbootstrap">
                                        <a href="#"
                        ...
                        <div class="buttons-wrapper">
                            <a href="#"
                                class="btn-lrg-standard btn-contact-me js-contact-me js-open-popup-join">Contact
                                Me</a>
                ...
                <div class="seller-profile">
                    <div class="description">
                        <h3>Description</h3>
                        <p>I am a Voice Actress with over 16+ years experience in everything from video games to
                            phone
                            systems to explainer videos to children's books.
                            I am originally from the South East of England and have a natural British accent, as
                            well as a
                    ...
                    <div class="linked-accounts">
                        ...
                        <ul>
                            <li class="platform social-account facebook"><i class="platform-icon facebook hint--top"
                                    aria-hidden="true" data-hint="facebook"></i><span class="text">facebook</span>
                            </li>
                ...
                <div class="recommended">
                    <div class="row">
                                    ...
                                    <div class="inner-wrapper">
                                        <div class="d-flex align-items-center">
                                            <span class="seller-image">
                                                <img class="img-fluid" src="/front/images/user/s1.png" alt='' />
                                            </span>
                                        ...
                                        <h3>I will create professional audio ads or radio commercials for your
                                            project</h3>
                        ...
                        <div class="col-md-4">
                            <div>
                                <a href="#">
                                    <img class="img-fluid" src="/front/images/list/v2.png" />
                                </a>
                                <div class="inner-slider">
                                    <div class="inner-wrapper">
                                        <div class="d-flex align-items-center">
                                            <span class="seller-image">
                                                <img class="img-fluid" src="/front/images/user/s2.png" alt='' />
                                            </span>
                                            <span class="seller-name">
                                                <a href="profile.html">Marcin Kowalski</a>
                                                <span class="level hint--top level-one-seller">
                        ...
                        <div class="col-md-4">
                            <div>
                                <a href="#">
                                    <img class="img-fluid" src="/front/images/list/v3.png" />
                                </a>
                                <div class="inner-slider">
                                    <div class="inner-wrapper">
                                        <div class="d-flex align-items-center">
                                            <span class="seller-image">
                                                <img class="img-fluid" src="/front/images/user/s3.png" alt='' />
                                            </span>
                                            <span class="seller-name">
                                                <a href="profile.html">Marcin Kowalski</a>
                                                <span class="level hint--top level-one-seller">
                    ...
                    <ul>
                        <li>
                            <div class="d-flex">
                                <div class="left">
                                    <span>
                                        <img src="/front/images/user/s9.png" class="profile-pict-img img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="right">
                                    <h4>
                        ...
                        <li>
                            <div class="d-flex">
                                <div class="left">
                                    <span>
                                        <img src="/front/images/user/s8.png" class="profile-pict-img img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="right">
                                    <h4>
                                    ...
                                    <div class="country d-flex align-items-center">
                                        <span>
                                            <img class="country-flag img-fluid" src="/front/images/flag/flag.png">
                                        </span>
                        ...
                        <li>
                            <div class="d-flex">
                                <div class="left">
                                    <span>
                                        <img src="/front/images/user/s7.png" class="profile-pict-img img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="right">
                                    <h4>
                                    ...
                                    <div class="country d-flex align-items-center">
                                        <span>
                                            <img class="country-flag img-fluid" src="/front/images/flag/uk.png">
                                        </span>
                        ...
                        <li>
                            <div class="d-flex">
                                <div class="left">
                                    <span>
                                        <img src="/front/images/user/s6.png" class="profile-pict-img img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="right">
                                    <h4>
                                    ...
                                    <div class="country d-flex align-items-center">
                                        <span>
                                            <img class="country-flag img-fluid" src="/front/images/flag/australia.png">
                                        </span>
